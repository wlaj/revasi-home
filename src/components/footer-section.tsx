      ...
      <SectionContainer className="py-16 md:py-24">
        <AnimatedGroup preset="slide" className="space-y-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 mt-10 border-t border-muted/40 text-sm text-foreground/70">
            <p>
              © {new Date().getFullYear()} Revasi. All rights reserved. Made by{" "}
              <Link
...
function SocialLinks() {
  return (
    <div className="flex items-center gap-4">
      ...
      <SocialIcon
        href="https://github.com/Locavore-Group"
        aria-label="GitHub"
        icon={
          <svg
      ...
      <SocialIcon
        href="https://www.instagram.com/locavorenxt/"
    ...
    <>
      {links.map((group, i) => (
        <div key={i} className="space-y-5">
          <h3 className="text-sm font-medium tracking-wide uppercase text-muted-foreground/70">
            {group.group}
          </h3>
